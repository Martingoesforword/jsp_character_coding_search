...
public class Op_user implements java.io.Serializable{
	...
	//显示所有用户
	public java.util.ArrayList<UserBean> showuser(javax.servlet.http.HttpServletRequest request) throws SQLException{
		//throws Exception{
		//if(request.getParameter("userName")==null){
		//		return null;
		//}
		...
		java.util.ArrayList<UserBean> al = new java.util.ArrayList<UserBean>();
		DataBase db = new DataBase();
		conn = db.getconn();
		pstmt = conn.prepareStatement(sqlStr);
